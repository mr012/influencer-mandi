...
return ()=>{tiltCleanups.forEach(cleanup=>cleanup());clearTimeout(timer);clearInterval(interval);observer.disconnect();page.removeEventListener('pointermove',move);page.removeEventListener('pointerleave',leave)};
